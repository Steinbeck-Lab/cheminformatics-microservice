...
import { AlertCircle, Clipboard, FileSearch, Loader2 } from "lucide-react";
...
const HOSECodeView = () => {
  ...
  return (
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      {/* Loading State */}
      {loading && hoseCodes.length === 0 && <ToolSkeleton variant="descriptors" />}
      ...
      {hoseCodes.length > 0 && !loading && !error && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700 shadow-xs overflow-y-auto max-h-96">
