  ...
  return (
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-blue-400 mb-4">Natural Product Likeness Score</h2>
      ...
      {typeof npScore === 'number' && !isNaN(npScore) && !loading && !error && (
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
          ...
          <div className="flex items-center justify-between mb-4 border-b border-gray-200 dark:border-gray-700 pb-3">
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">NP-likeness Results</h3>
            ...
            <button
              ...
              onClick={() => alert('Info about NP-likeness score ranges:\n\n> 1: Very High NP-like\n0 to 1: High NP-like\n-1 to 0: Moderate NP-like\n-2 to -1: Low NP-like\n< -2: Very Low NP-like (Synthetic)')} // Simple alert for now
            >
          ...
          <div className="space-y-8"> {/* Increased spacing */}
            ...
            <div className="text-center">
              ...
              {/* Interpretation Text */}
              <p className="text-sm text-gray-600 dark:text-gray-400">{getNpScoreInterpretation(npScore)}</p>
            </div>

            {/* Score Gauge Visualization */}
            <div className="relative pt-6 px-2"> {/* Added padding */}
              ...
              <div className="overflow-hidden h-2.5 mb-4 flex rounded-full bg-gray-200 dark:bg-gray-700 shadow-inner">
                ...
                <div className="h-full w-[30%] bg-gradient-to-r from-red-500 to-orange-500"></div>        {/* -5 to -2 */}
                <div className="h-full w-[10%] bg-gradient-to-r from-orange-500 to-amber-500"></div>       {/* -2 to -1 */}
                <div className="h-full w-[10%] bg-gradient-to-r from-amber-500 to-blue-500"></div>        {/* -1 to 0 */}
                <div className="h-full w-[10%] bg-gradient-to-r from-blue-500 to-green-400"></div>       {/* 0 to 1 */}
                <div className="h-full w-[40%] bg-gradient-to-r from-green-400 to-green-600"></div>      {/* 1 to 5 */}
              </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg text-sm text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 shadow-sm">
              <p>
                <strong>About NP-likeness Score:</strong> This score measures molecular similarity to known natural products, ranging from -5 (synthetic-like) to +5 (natural product-like).
              </p>
              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                Calculation based on RDKit implementation of the method by Ertl et al., J. Cheminform. 1:8 (2008).
              </p>
            </div>
          </div>
        </div>
