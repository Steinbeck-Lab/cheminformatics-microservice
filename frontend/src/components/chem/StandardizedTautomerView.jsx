  ...
  return (
    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-blue-400 mb-4">Standardized Tautomer Generator</h2>
      ...
      {error && !loading && (
        <div className={`p-4 rounded-md flex items-start shadow ${
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="text-md font-medium text-gray-700 dark:text-gray-300 mb-2">Original Structure</h4>
                ...
                <div className="mt-2 bg-gray-100 dark:bg-gray-900 p-2 rounded-md border border-gray-200 dark:border-gray-700 font-mono text-xs overflow-x-auto shadow-sm">
                  <pre className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap break-all">{smiles}</pre>
                </div>
              </div>

              {/* Standardized Structure Column */}
              <div>
                <h4 className="text-md font-medium text-blue-700 dark:text-blue-300 mb-2">Standardized Tautomer</h4>
                 {/* Ensure MoleculeCard is theme-aware */}
                <MoleculeCard
                ...
                <div className="mt-2 bg-gray-100 dark:bg-gray-900 p-2 rounded-md border border-gray-200 dark:border-gray-700 font-mono text-xs overflow-x-auto shadow-sm">
                  <pre className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap break-all">{standardizedSmiles}</pre>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900 dark:bg-opacity-20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 shadow">
            <h4 className="text-md font-medium text-blue-800 dark:text-blue-300 mb-2">About Tautomers</h4>
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Tautomers are constitutional isomers that readily interconvert, typically involving proton migration and a shift in double bonds (e.g., keto-enol).
            </p>
            <p className="text-sm text-gray-700 dark:text-gray-300 mt-2">
              The standardized tautomer is the canonical form chosen by RDKit's TautomerEnumerator for consistent representation.
            </p>
          </div>
        </div>
      )}
      ...
      {!standardizedSmiles && !loading && !error && (
        <div className="bg-blue-50 dark:bg-blue-900 dark:bg-opacity-20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 flex items-start space-x-4 shadow" role="complementary">
          ...
          <div>
            <h3 className="text-lg font-medium text-blue-800 dark:text-blue-300 mb-2">About Tautomer Standardization</h3>
            <p className="text-gray-700 dark:text-gray-300">
              Tautomers are structural isomers (like keto-enol forms) that interconvert. This tool finds a consistent, canonical tautomeric form using RDKit.
            </p>
            {/* Example Section */}
            <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-gray-100 dark:bg-gray-900 p-3 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">Example (Keto form):</p>
                <pre className="text-xs text-gray-700 dark:text-gray-300 font-mono">CC(=O)CC</pre>
              </div>
              {/* Enol Example */}
              <div className="bg-gray-100 dark:bg-gray-900 p-3 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
                <p className="text-gray-500 dark:text-gray-400 text-sm mb-1">Example (Enol form):</p>
                <pre className="text-xs text-gray-700 dark:text-gray-300 font-mono">CC(O)=CC</pre>
              </div>
            </div>
