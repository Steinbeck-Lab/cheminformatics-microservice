            ...
            <div className="p-8 md:p-10">
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <p className="text-slate-700 dark:text-slate-300">
                  Cheminformatics Microservice ("us", "we", or "our") operates
                  the https://api.naturalproducts.net/ website and related
                  applications (hereinafter referred to as the "Service").
                </p>
                ...
                <ul className="text-slate-700 dark:text-slate-300">
                  <li>
                    <strong>Service:</strong> Service refers to the
                    https://api.naturalproducts.net/ website and related
                    applications operated by the Steinbeck group at Friedrich
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  We collect limited information for the purposes of monitoring
                  service usage and improving our Service. Our approach
                  prioritizes privacy, and we collect only what is necessary for
                  these purposes.
                </p>
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  We collect anonymized usage data to understand how our Service
                  is accessed and used. This information helps us improve our
                  service and ensure it meets user needs. This Usage Data may
                  include:
                </p>
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  For searches conducted on our platform, we do not track
                  individual search history on our servers. When using our
                  chemical structure search features, search history may be
                  stored locally on your device for convenience, but this data
                  is not transmitted to our servers. Additionally, our system
                  does not retain information related to search queries that
                  return zero results.
                </p>

                <p className="text-slate-700 dark:text-slate-300">
                  We may collect and analyze aggregated search keywords to
                  improve performance and optimize the user experience. These
                  anonymized keywords, along with related logs and reports, are
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  ...
                  activity on our Service and to improve user experience.
                  Cookies are files with a small amount of data which may
                  include an anonymous unique identifier. You can instruct your
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  We use the following analytics service to monitor and analyze
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  Matomo is used to analyze visitor behavior to identify
                  potential improvements and understand how users interact with
                  our Service. All data is processed with privacy in mind, and
                  we employ the following privacy-protective measures:
                </p>

                <ul className="text-slate-700 dark:text-slate-300">
                  <li>IP addresses are anonymized</li>
                  <li>
                    Data is stored on our own servers, not shared with third
                    parties
                  </li>
                  <li>We honor Do Not Track preferences</li>
                  <li>
                    Analytics data is automatically deleted after 365 days
                  </li>
                </ul>

                <p className="text-slate-700 dark:text-slate-300">
                  The processing of this data is based on our legitimate
                  interest to improve our Service and user experience.
                </p>
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  ...
                  described in this Privacy Policy depends on the data we
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  ...
                  the purposes set out in this Privacy Policy. We retain and use
                  your data to the extent necessary to comply with our legal
                  obligations, resolve disputes, and enforce our policies.
                </p>

                <p className="text-slate-700 dark:text-slate-300">
                  Usage data is generally retained for a shorter period. We
                  automatically delete analytics data after 365 days.
                </p>
                ...
                <p className="text-slate-700 dark:text-slate-300">
                  ...
                  contact the Steinbeck group at the Friedrich Schiller
                  University Jena:
                </p>
