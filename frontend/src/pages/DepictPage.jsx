...
const tabContainerVariant = {
  ...
  visible: { opacity: 1, y: 0, scale: 1, transition: { duration: 0.6, delay: 0.25, ease: [0.2, 0.65, 0.3, 0.9] } }
};
  ...
  return (
    ...
    >
                  ...
                  {tabs.map((tab) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`tab-button relative flex items-center px-5 py-3 text-sm font-medium rounded-lg transition-colors duration-200 whitespace-nowrap focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--bg-secondary)] focus-visible:ring-[var(--text-accent)] ${isActive
            ...
            <div className="relative overflow-hidden min-h-[50vh]">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  {ActiveComponent && <ActiveComponent isActive={activeTabId === '3d-depiction'} />}
                </motion.div>
              </AnimatePresence>
            </div>
      ...
      <style jsx global>{`
        ...
        .tab-button::before { /* ... same as before ... */ }
        .tab-button:not([aria-selected='true']):hover::before { /* ... same as before ... */ }
      `}</style>
