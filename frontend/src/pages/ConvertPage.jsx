...
const ConvertPage = () => {
  ...
  useEffect(() => {
    if (convertId) {
      ...
      if (tab) {
        ...
        // Invalid convertId, redirect to first tab
  ...
  const handleTabSelection = (tabId) => {
    ...
    // Note: Not updating URL, keeping it at /convert
  };
        ...
        <div className="w-full lg:w-3/4 mx-auto">
          ...
          >
            ...
            {activeTab && (
              ...
              >
                <div className="bg-gradient-to-r from-teal-500 to-cyan-600 dark:from-teal-700 dark:to-cyan-900 rounded-xl shadow-xl overflow-hidden relative">
