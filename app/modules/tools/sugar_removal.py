...
def remove_linear_sugar(molecule: any,
    ...
    Args:
        ...
        preservation_mode (preservation_modes_enum): Mode to determine which disconnected structures to preserve. Default is preservation_modes_enum.HEAVY_ATOM_COUNT.
        ...
        linear_sugars_min_size (int): Minimum size of linear sugars to consider. Default is 4. Must be positive and higher than or equal to 1 and also smaller than the linear sugar candidate maximum size.
...
def remove_circular_sugar(molecule: any,
    ...
    Args:
        ...
        preservation_mode (preservation_modes_enum): Mode to determine which disconnected structures to preserve. Default is preservation_modes_enum.HEAVY_ATOM_COUNT.
        preservation_threshold (int): Threshold value for the selected preservation mode. Default is 5 (heavy atoms).
        oxygen_atoms (bool): Whether to consider only circular sugars with a sufficient number of exocyclic oxygen atoms in the removal process (see oxygen_atoms_threshold). Default is True.
        oxygen_atoms_threshold (float): A number giving the minimum attached exocyclic oxygen atoms to atom number in the ring ratio a circular sugar needs to have to be considered in the removal process. Default is 0.5 (a 6-membered ring needs at least 3 attached exocyclic oxygen atoms). Must be positive!
