...
def getSugarInfo(molecule: any) -> tuple:
    """
...
def removeLinearSugar(molecule: any) -> str:
    """
...
def removeCircularSugar(molecule: any) -> str:
    """
...
def removeLinearandCircularSugar(molecule: any):
